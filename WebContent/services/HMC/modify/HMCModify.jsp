	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 blog-content">
				<form action="hmc?command=HmcUpdate" name="write" method="post"
					class="form-group">
					<input type="hidden" name="num" value="${hvo.num }">
					<h3 style="border-bottom: 1px solid #555;" class="mb-4">
						<input type="text" name="title" value="${hvo.title }"
							class="form-control">
					</h3>
					<textarea name="content" id="summernote">${hvo.content }</textarea>
					...
					<div class="btn-group" style="margin-top: 15px;">
						<div class="form-group">
							<input type="submit" value="修正" class="btn btn-primary"
								...
								type="submit" href="header?command=HMC" class="btn btn-info"
