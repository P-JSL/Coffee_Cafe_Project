	...
	<div class="container" style="position: relative;">
		<div class="row">
			<div class="col-lg-10 blog-content">
				<form action="news?command=newsInsert" name="write"
					enctype="multipart/form-data" method="post" class="form-group" onsubmit="return newscheck();">
					...
					<textarea name="n_content" id="summernote"></textarea>

					<div class="file_input">
						<label> File Attach <input type="file"
							onchange="javascript:document.getElementById('file_route').value=this.value" name="photo" id="file">
					...
					<div class="btn-group" style="margin-top: 10px;">
						<div class="form-group">
							<input type="submit" value="作成" class="btn btn-warning btn-md"
