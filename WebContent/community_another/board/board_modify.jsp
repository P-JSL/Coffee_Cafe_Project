	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 blog-content">
				<form action="board" name="write"
					method="post" class="form-group">
					<input type="hidden" name="command" value="boardModify">
					<input type="hidden" value="off" id="password-on"
						name="password-on"> <input type="hidden"
					...
					<textarea name="content" id="summernote">${bvo.b_content }</textarea>
					...
					<div class="btn-group" style="margin-top: 20px;">
						<div class="form-group">
							<input type="submit" value="修正" class="btn btn-primary btn-md"
								...
								href="javascript:history.go(-1);" class="btn btn-primary" >戻る</a>
						</div>
					</div>
				</form>
				<!-- END comment-list -->
