	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 blog-content">
				<form action="notice" name="write" method="post"
					class="form-group">
					<input value="noticeModify" name="command" type="hidden"> 
					<input type="hidden" name="id" value="${sessionScope.id }">
					<input type="hidden" name="num" value="${nvo.num }">
					<h3 style="border-bottom: 1px solid #555;" class="mb-4">
						<input type="text" name="title" value="${nvo.n_title }"
							class="form-control">
					</h3>
					<textarea name="content" id="summernote">${nvo.n_content }</textarea>

					<div class="btn-group">
						<div class="form-group">
							<input type="submit" value="修正"
								class="btn btn-primary btn-md" class="form-control">
								<a class="btn btn-primary btn-md" href="javascript:history.go(-1);">戻る</a>
						</div>
					</div>
				</form>
				<!-- END comment-list -->
