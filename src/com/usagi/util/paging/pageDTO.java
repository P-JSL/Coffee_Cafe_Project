package com.usagi.util.paging;

public class pageDTO {

	private int totalcount;// 전체 게시물 개수
	
	private int pagenum =1;// 첫페이지를 표시하기 위함, 페이지 번호를 나타낸다
	...
	private int currentblock = 1; // 블록 = 1; , 블록 = (현제 페이지 -1 ) / 보여줄 페이지 갯수 이고, 블록 시작 번호 = (보여줄 페이지번호+ 블록 ) + 1
									// , 마지막 블록 = (블록 시작 ) + (보여줄 페이지번호 - 1)
