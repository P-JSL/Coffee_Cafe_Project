...
public class naver_forgot {
	public naver_forgot(HttpServletRequest request, HttpServletResponse response,String url, String newpw) throws ServletException, IOException {
