...
public class gmail_forgot {
	public gmail_forgot(HttpServletRequest request, HttpServletResponse response,String url, String newpw) throws UnsupportedEncodingException {
